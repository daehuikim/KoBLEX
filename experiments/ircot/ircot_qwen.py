...
class LlmGenerator:
    """vLLM generator for IRCoT reasoning with Qwen."""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="IRCoT legal reasoning using Qwen model"
    )
    ...
    parser.add_argument(
        "--output_file", 
        type=str, 
        default="ircot_qwen_results.jsonl",
