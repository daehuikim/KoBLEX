#!/usr/bin/env python3
"""
Chain-of-Thought Question Answering Generator (VLLM)

This script generates legal answers using chain-of-thought reasoning with VLLM.
...
from ..prompts.naive_prompt import COT_SYSTEM_PROMPT, COT_QA_PROMPT
...
def make_qa_prompts(data):
    ...
    prompts = [COT_QA_PROMPT.substitute(question=data['background'] + data['question'])]
    return prompts
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Legal QA using chain-of-thought reasoning with VLLM"
    )
